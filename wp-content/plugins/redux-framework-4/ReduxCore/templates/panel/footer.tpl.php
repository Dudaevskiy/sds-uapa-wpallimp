	...
	<div id="redux-footer">
		...
		<div class="redux-action_bar">
			...
			if ( false === $this->parent->args['hide_save'] ) {
				submit_button( esc_html__( 'Save Changes', 'redux-framework' ), 'primary', 'redux_save', false, [ 'id' => 'redux_bottom_save' ] );
			}

			if ( false === $this->parent->args['hide_reset'] ) {
				submit_button( esc_html__( 'Reset Section', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, [ 'id' => 'redux-defaults-section-bottom' ] );
				submit_button( esc_html__( 'Reset All', 'redux-framework' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, [ 'id' => 'redux-defaults-bottom' ] );
			}
			?>
		</div>
