	...
	class Redux_Spinner extends Redux_Field {
		...
		public function render() {
			...
			foreach ( $this->field as $key => $val ) {
				if ( in_array( $key, [ 'min', 'max', 'step', 'default', 'plus', 'minus', 'prefix', 'suffix', 'point', 'places' ], true ) ) {
		...
		public function enqueue() {
			...
			wp_enqueue_script(
				...
				[ 'jquery', 'redux-field-spinner-custom-js', 'jquery-ui-core', 'jquery-ui-dialog', 'redux-js' ],
				$this->timestamp,
				true
			);
