...
if ( ! class_exists( 'Redux_Dimensions', false ) ) {
	...
	class Redux_Dimensions extends Redux_Field {
		...
		public function render() {
			...
			$arr_units = [ '', false, '%', 'in', 'cm', 'mm', 'em', 'ex', 'pt', 'pc', 'px', 'rem', 'vh', 'vw', 'vmin', 'vmax', 'ch' ];
			...
			$arr_units = [ '', '%', 'in', 'cm', 'mm', 'em', 'ex', 'pt', 'pc', 'px', 'rem', 'vh', 'vw', 'vmin', 'vmax', 'ch' ];
			...
			if ( isset( $this->field['units'] ) && false !== $this->field['units'] ) {
				...
				if ( $this->field['units_extended'] ) {
					$test_units = [ 'px', 'em', 'rem', '%', 'in', 'cm', 'mm', 'ex', 'pt', 'pc', 'vh', 'vw', 'vmin', 'vmax', 'ch' ];
				} else {
