...
if ( ! class_exists( 'Redux_Spacing', false ) ) {
	...
	class Redux_Spacing extends Redux_Field {
		...
		public function render() {
			...
			$unit_arr = [ '', false, '%', 'in', 'cm', 'mm', 'em', 'rem', 'ex', 'pt', 'pc', 'px', 'vh', 'vw', 'vmin', 'vmax', 'ch' ];
			...
			if ( ! in_array( $this->field['mode'], [ 'margin', 'padding' ], true ) ) {
			...
			if ( false !== $this->field['units'] && true === $this->field['display_units'] ) {
				...
				if ( $this->field['units_extended'] ) {
					$test_units = [ 'px', 'em', 'rem', '%', 'in', 'cm', 'mm', 'ex', 'pt', 'pc' ];
				} else {
					$test_units = [ 'px', 'em', 'pt', 'rem', '%' ];
				}
		...
		public function css_style( $data ) {
			...
			if ( ! in_array( $this->field['mode'], [ 'padding', 'absolute', 'margin' ], true ) ) {
				$this->field['mode'] = 'padding';
			}
