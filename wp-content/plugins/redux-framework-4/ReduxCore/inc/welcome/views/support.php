		...
		<form id="supportform">
			...
			<fieldset>
				...
				<p>
					...
					<?php echo sprintf( wp_kses( __( 'This will provide to your developer all the information they may need to remedy your issue. This action WILL send information securely to a remote server. To see the type of information sent, please look at the  <a href="%s">Health Check</a> tab.', 'redux-framework' ), [ 'a' => [ 'href' => [] ] ] ), esc_url( admin_url( 'tools.php?page=redux-health' ) ) ); ?>
				</p>
