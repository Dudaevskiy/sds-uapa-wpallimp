...
if ( ! class_exists( 'Redux_Welcome', false ) ) {
	...
	class Redux_Welcome {
		...
		public function do_redirect() {
			if ( ! defined( 'WP_CLI' ) ) {
				wp_safe_redirect( esc_url( admin_url( add_query_arg( [ 'page' => 'redux-framework' ], 'tools.php' ) ) ) );
				exit();
			}
		}
		...
		public function admin_menus() {
			...
			// About Page.
			$page( esc_html__( 'What is Redux Framework?', 'redux-framework' ), esc_html__( 'Redux Framework', 'redux-framework' ), $this->minimum_capability, 'redux-framework', [ $this, 'about_screen' ] );

			// Support Page.
			$page( esc_html__( 'Get Support', 'redux-framework' ), esc_html__( 'Get Support', 'redux-framework' ), $this->minimum_capability, 'redux-support', [ $this, 'get_support' ] );

			// Status Page.
			$page( esc_html__( 'Redux Health Check', 'redux-framework' ), esc_html__( 'Redux Health Check', 'redux-framework' ), $this->minimum_capability, 'redux-health', [ $this, 'heath_check' ] );
		...
		public function tabs() {
			...
			<h2 class="nav-tab-wrapper">
				<a
					...
					href="<?php echo esc_url( admin_url( add_query_arg( [ 'page' => 'redux-framework' ], 'tools.php' ) ) ); ?>">
				...
				<a
					...
					href="<?php echo esc_url( admin_url( add_query_arg( [ 'page' => 'redux-health' ], 'tools.php' ) ) ); ?>">
