...
if ( ! class_exists( 'Redux_Metaboxes' ) ) {
	...
	class Redux_Metaboxes {
		...
		public static function load() {
			...
			add_action( 'init', [ 'Redux_Metaboxes', 'enqueue' ], 99 );
		}
		...
		public static function enqueue() {
			...
			$pagenows = [ 'post-new.php', 'post.php' ];
		...
		public static function filter_metaboxes() {
			...
			foreach ( self::$boxes as $opt_name => $the_boxes ) {
				if ( ! self::$init[ $opt_name ] ) {
					...
					add_action( 'redux/metaboxes/' . $opt_name . '/boxes', [ 'Redux_Metaboxes', 'addMetaboxes' ], 2 );
				}
			}
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function processSectionsArray( $opt_name = '', $box_id = '', $sections = [] ) {  // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @param array  $sections Sections array.
		 */
		public static function process_sections_array( $opt_name = '', $box_id = '', $sections = [] ) {
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function processFieldsArray( $opt_name = '', $section_id = '', $fields = [] ) {  // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function setField( $opt_name = '', $field = [] ) {  // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
			self::set_field( $opt_name, $field );
		}
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function setBox( $opt_name = '', $box = [] ) {  // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @param array  $box Box array.
		 */
		public static function set_box( $opt_name = '', $box = [] ) {
			Redux_Functions_Ex::record_caller( $opt_name );
		 ...
		 * @deprecated 4.0.0 No more camelCase.
		 */
		public static function setBoxes( $opt_name = '', $boxes = [] ) {  // phpcs:ignore: WordPress.NamingConventions.ValidFunctionName
		 ...
		 * @param array  $boxes Boxes array.
		 */
		public static function set_boxes( $opt_name = '', $boxes = [] ) {
			Redux_Functions_Ex::record_caller( $opt_name );
